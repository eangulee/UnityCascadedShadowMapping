...
public class DepthTextureCamera : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        _camera.RenderWithShader(Shader.Find("Custom/ShadowMap/DeapthTextureShader"), "");
    }
    ...
    void Update()
    {
        ...
        Shader.SetGlobalMatrix("_gProjectionMatrix", tm);
        Shader.SetGlobalTexture("_gDepthTexture", _rt);
    }
